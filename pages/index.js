  ...
  return (
    <div className={styles.mainContainer}>
          ...
          <SwiperSlide>
            <div className={styles.protocolAction}>
              ...
              <div className={styles.skillContent}>
                <h3>Select Donees</h3>
                <p>
                  Users holding governance token (given to donators), will be
                  able to vote on the Donees Petitions Forms for them to be
      ...
      <section className={styles.testContainer}>
        ...
        <p>
          This protocol is was made for testing my learned skills in Solidity,
          with all of the technology required to take it here.
        </p>
      </section>
              ...
              <figure className={`${styles.skill} ${styles.t2}`}>
                <div className={styles.personInfoDiv}>
                  <figcaption className={styles.skillDescription}>
                    ...
                    <p className={styles.status}>Frontend</p>
                  </figcaption>
                </div>
                <blockquote className={styles.skillContent}>
                  <p className={styles.skillBody}>
